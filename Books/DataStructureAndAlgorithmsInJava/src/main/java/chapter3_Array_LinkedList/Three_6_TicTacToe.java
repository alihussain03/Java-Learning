 ...
 */
public class Three_6_TicTacToe {
    public static final int X = 1, O = -1;   // players
    public static final int EMPTY = 0;
    private int board[][] = new int[3][3];
    private int player;

    public Three_6_TicTacToe() {
        clearBoard();
    }
    ...
    public static void main(String[] args) {
        Three_6_TicTacToe game = new Three_6_TicTacToe();

        game.putMark(1, 1); //First Player
        game.putMark(0, 2);
        game.putMark(2, 2);//First Player
        game.putMark(0, 1);
        game.putMark(0, 0); //First Player
        game.putMark(2, 1);
        game.putMark(1, 2); //First Player
        game.putMark(1, 0);
        game.putMark(2, 0); //First Player
