...
public class Six_8_Circular_Queue_Using_Arrays_2<T> {
    ...
    public Six_8_Circular_Queue_Using_Arrays_2(Class<T> clazz) {
        this(clazz, MAX_SIZE);
    }

    public Six_8_Circular_Queue_Using_Arrays_2(Class<T> clazz, int size) {
    ...
    public static void main(String[] args) throws QueueOverflowException, QueueUnderflowException {
        MAX_SIZE = 4;
        Six_8_Circular_Queue_Using_Arrays_2<Integer> queue = new Six_8_Circular_Queue_Using_Arrays_2<>(Integer.class);
