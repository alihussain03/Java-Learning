...
public class Six_7_CircularQueue_Using_Arrays<E> implements Six_6_QueueInterface<E> {

    private E[] data;
    private int front = 0;
    private int size = 0;

    public Six_7_CircularQueue_Using_Arrays(int capacity) {
    ...
    public static void main(String[] args) {
        Six_7_CircularQueue_Using_Arrays<Integer> circular_queue = new Six_7_CircularQueue_Using_Arrays<Integer>(4);
